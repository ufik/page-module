 ...
 */
class VideogalleryPresenter extends \AdminModule\BasePresenter {
	...
	public function actionDefault($id){
		...
		/*$this->videogallery = $this->em->getRepository('WebCMS\PageModule\Doctrine\Photogallery')->findOneBy(array(
			'page' => $this->page
		));*/
